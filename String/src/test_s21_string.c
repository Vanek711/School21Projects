...
START_TEST(s21_test_insert) {
  ...
  const char *expectedIns = "Hello, 123ld!";
  char *result = s21_insert(src, str, start_index);
  ck_assert_str_eq(result, expectedIns);
  free(result);
}
END_TEST
...
START_TEST(to_insert_1) {
  ...
  const char *str2 = "Billy and ";
  char *str3 = s21_insert(str1, str2, 0);
  ck_assert_str_eq(str3, "Billy and ster");
  free(str3);
}
END_TEST
...
//   ck_assert_str_eq(str3, "adefde");
//   free(str3);
// }
// END_TEST

START_TEST(to_insert_4) {
  const char *str1 = "abc\0hello";
  const char *str2 = "1";
  char *str3 = s21_insert(str1, str2, 2);
  ck_assert_str_eq(str3, "ab1");
  free(str3);
}
END_TEST
...
Suite *string_suite(void) {
  ...
  tcase_add_test(tc_core, s21_test_insert);
  tcase_add_test(tc_core, s21_insert_normal);
  tcase_add_test(tc_core, s21_insert_invalid_index);
  tcase_add_test(tc_core, to_insert_1);
  tcase_add_test(tc_core, to_insert_2);
  //  tcase_add_test(tc_core, to_insert_3);
  tcase_add_test(tc_core, to_insert_4);
